	...
	sysop: {
		...
		deleteTalk: function( params ) {
			...
			if (params.deleteTalkPage &&
				...
				talkpage.setEditSummary('[[Wikiversity:CSD|G15]]: 孤立页面: 已删除页面“' + Morebits.pageNameNorm + "”的讨论页" + Twinkle.getPref('deletionSummaryAd'));
				talkpage.deletePage();
		...
		deleteRedirectsMain: function( apiobj ) {
			...
			$snapshot.each(function(key, value) {
				...
				page.setEditSummary('[[Wikiversity:CSD|G15]]: 孤立页面: 重定向到已删除页面“' + Morebits.pageNameNorm + "”" + Twinkle.getPref('deletionSummaryAd'));
